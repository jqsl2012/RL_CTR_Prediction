...
class Hybrid_RL_Model():
    ...
    def choose_action(self, state, exploration_rate):
        ...
        return random_c_actions, ensemble_c_actions, random_d_q_values, ensemble_d_actions.view(-1, 1)
    ...
    def learn(self, embedding_layer):
        ...
        # Critic
        c_actions_means_for_critic, d_actions_q_values_for_critic = self.Hybrid_Actor.evaluate(b_s)
